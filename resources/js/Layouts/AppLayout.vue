                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <inertia-link :href="route('admin.posts')">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('admin.posts')" :active="route().current('admin.posts')">
                                Posts
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.posts.create')" :active="route().current('admin.posts.create')">
                                Create Post
                            </jet-nav-link>
                        </div>
                    </div>
